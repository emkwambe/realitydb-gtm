...
## Status Key
- FOUND — identified, not yet contacted
- SENT — outreach sent, awaiting response
- REPLIED — responded, conversation active
- MEETING — meeting scheduled
- CLOSED — converted to customer
- PASS — not a fit

## Tier 1 — Charlotte Banking

| Name | Title | Company | LinkedIn | Status | Notes |
|------|-------|---------|----------|--------|-------|
| Pascal Belaud | Chief AI & Data Officer | Truist Financial | Search: Pascal Belaud Truist | FOUND | New Nov 2025, ex-Microsoft 25yr, building data strategy from scratch — highest priority |
| Lo Li | Chief Divisional Technology & Data Officer | Truist Financial | Search: Lo Li Truist | FOUND | New Dec 2025, ex-Capital One CTO — already understands synthetic data value |
